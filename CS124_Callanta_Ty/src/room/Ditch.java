...
public class Ditch {
	...
	public String getDescription()
	{
		...
		output += "Willy Butte is a racecar track. In the distance you see a ditch and can hear someone calling for help. \n";
	...
	public String searchArea(){
		String output = "";
		output += "You try to find a rope, to help get Marga out. Nothing seems to be of use \n";
		return output;
	}
